...
* 순서가 없는 목록
  ...
  * `tab`을 눌러서 하위 항목을 생성할 수 있고 `shift + tab`키를 눌러서 상위 항목으로 이동할 수 있습니다.
* 순서가 있는 목록
...
* 로컬에 이미지파일을 저장한 경우 절대 경로가 아닌 상대경로를 사용하여 이미지를 저장합니다.

!["GitHub Image"](git_img.PNG)
...
[dayoungMM의 Github](https://github.com/dayoungMM)
